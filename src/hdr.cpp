...
HdrMetadata hdr10_preset()
{
    ...
    md.red_x = 34000; md.red_y = 16000;
    md.green_x = 13250; md.green_y = 34500;
    md.blue_x = 7500; md.blue_y = 3000;
    md.white_x = 15635; md.white_y = 16450;
...
{
    switch (tf) {
        case TransferFunction::PQ: return "SMPTE-ST-2084";
        case TransferFunction::HLG: return "ARIB-STD-B67";
        case TransferFunction::Linear: return "Linear";
        default: return "BT.1886";
    }
}
...
std::string generate_color_metadata_xml(const HdrMetadata& meta)
{
    ...
    xml << "      <r1:Color>\n";
    xml << "        <r1:Colorimetry>" << colorimetry_to_string(meta.colorimetry) << "</r1:Colorimetry>\n";
    ...
    if (meta.mastering_display.has_value()) {
        ...
        xml << "            <r1:Red><r1:X>" << md.red_x << "</r1:X><r1:Y>" << md.red_y << "</r1:Y></r1:Red>\n";
        xml << "            <r1:Green><r1:X>" << md.green_x << "</r1:X><r1:Y>" << md.green_y << "</r1:Y></r1:Green>\n";
        xml << "            <r1:Blue><r1:X>" << md.blue_x << "</r1:X><r1:Y>" << md.blue_y << "</r1:Y></r1:Blue>\n";
        xml << "          </r1:DisplayPrimaries>\n";
        xml << "          <r1:WhitePoint><r1:X>" << md.white_x << "</r1:X><r1:Y>" << md.white_y << "</r1:Y></r1:WhitePoint>\n";
        xml << "          <r1:MaxDisplayMasteringLuminance>" << md.max_luminance << "</r1:MaxDisplayMasteringLuminance>\n";
        xml << "          <r1:MinDisplayMasteringLuminance>" << md.min_luminance << "</r1:MinDisplayMasteringLuminance>\n";
        xml << "        </r1:MasteringDisplayPrimaries>\n";
    }
