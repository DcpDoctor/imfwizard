...
std::string generate_qc_report_html(const QcReportOptions& opts)
{
  ...
  {
    if(n.severity == ValidationNote::Severity::error)
      ++errors;
    else if(n.severity == ValidationNote::Severity::warning)
      ++warnings;
  }
...
<h1>QC Report</h1>
<p class="meta">)"
       << opts.title << " — Generated " << date_buf << " by " << opts.author << R"(</p>

<div class="summary">
<div class="stat )"
       << (opts.validation.valid ? "pass" : "fail") << R"(">
<div class="value">)"
       << (opts.validation.valid ? "PASS" : "FAIL") << R"(</div>
<div class="label">Overall</div>
</div>
<div class="stat )"
       << (errors > 0 ? "fail" : "pass") << R"(">
<div class="value">)"
       << errors << R"(</div>
<div class="label">Errors</div>
</div>
<div class="stat )"
       << (warnings > 0 ? "warn" : "pass") << R"(">
<div class="value">)"
       << warnings << R"(</div>
...
<tr><td>Title</td><td>)"
       << info.cpl_title << R"(</td></tr>
<tr><td>CPL UUID</td><td>)"
       << info.cpl_uuid << R"(</td></tr>
<tr><td>PKL UUID</td><td>)"
       << info.pkl_uuid << R"(</td></tr>
<tr><td>Issuer</td><td>)"
       << info.issuer << R"(</td></tr>
<tr><td>Issue Date</td><td>)"
       << info.issue_date << R"(</td></tr>
</table>
)";
...
<tr><th>Type</th><th>Filename</th><th>Size</th></tr>
  ...
  {
    html << "<tr><td>" << t.type << "</td><td>" << t.filename << "</td><td>" << t.size
         << " bytes</td></tr>\n";
  }
  html << "</table>\n";
...
<tr><th>Severity</th><th>Message</th></tr>
    ...
    for(const auto& note : opts.validation.notes)
    {
      ...
      html << "<tr><td><span class=\"badge " << badge_class << "\">" << label << "</span></td><td>"
           << note.message << "</td></tr>\n";
    }
    html << "</table>\n";
  }
